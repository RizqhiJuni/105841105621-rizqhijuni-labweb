      ...
      <ScrollView>
        ...
        <View style={{ paddingHorizontal: 16, marginTop: 16 }}>
          <TouchableOpacity style={{ marginBottom: 16, flexDirection: 'row', alignItems: 'center', backgroundColor: '#F9F9F9', padding: 10, borderRadius: 8 }}>
            ...
            <Image source={require('./assets/foto1.jpeg')} style={{ width: 80, height: 80, borderRadius: 8 }} />
          </TouchableOpacity>
          <TouchableOpacity style={{ marginBottom: 16, flexDirection: 'row', alignItems: 'center', backgroundColor: '#F9F9F9', padding: 10, borderRadius: 8 }}>
            <Text style={{ fontSize: 18, fontWeight: '600', color: '#333333', flex: 1 }}>Clothes</Text>
            <Image source={require('./assets/foto2.jpeg')} style={{ width: 80, height: 80, borderRadius: 8 }} />
          </TouchableOpacity>
          <TouchableOpacity style={{ marginBottom: 16, flexDirection: 'row', alignItems: 'center', backgroundColor: '#F9F9F9', padding: 10, borderRadius: 8 }}>
            <Text style={{ fontSize: 18, fontWeight: '600', color: '#333333', flex: 1 }}>Shoes</Text>
            <Image source={require('./assets/foto3.jpeg')} style={{ width: 80, height: 80, borderRadius: 8 }} />
          </TouchableOpacity>
          <TouchableOpacity style={{ marginBottom: 16, flexDirection: 'row', alignItems: 'center', backgroundColor: '#F9F9F9', padding: 10, borderRadius: 8 }}>
            <Text style={{ fontSize: 18, fontWeight: '600', color: '#333333', flex: 1 }}>Accessories</Text>
            <Image source={require('./assets/foto4.jpeg')} style={{ width: 80, height: 80, borderRadius: 8 }} />
          </TouchableOpacity>
        </View>
      </ScrollView>
    </View>
